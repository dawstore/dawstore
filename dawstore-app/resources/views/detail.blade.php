        ...
        <div class="container">
            <div class="row mb-5">
                ...
                <div class="col-lg-6">
                    ...
                    </div><a class="text-dark p-0 mb-4 d-inline-block"
                        href="{{ route('whishlist.addProduct', $product->id) }}"><i class="bi bi-heart-fill"></i> Add to wish
                        list</a><br>
                @else
                    <div class="col-sm-3 pl-sm-0"><a
                            class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0 "
                            href="{{ route('cart.addProduct', $product->id) }}">Add to cart</a></div>
                </div><a class="text-dark p-0 mb-4 d-inline-block" href="{{ route('whishlist', $product->id) }}"><i
                        ...
                        <div class="col-lg-8">
                            <div class="d-flex mb-3">
                                <div class="flex-shrink-0"><img class="rounded-circle"
                                        src="{{ URL::asset('img/customer-1.png') }}" alt="" width="50" />
                                </div>
                            ...
                            <div class="d-flex">
                                <div class="flex-shrink-0"><img class="rounded-circle"
                                        src="{{ URL::asset('img/customer-2.png') }}" alt="" width="50" />
                                </div>
                                <div class="ms-3 flex-shrink-1">
                            ...
                            <div class="product-overlay">
                                <ul class="mb-0 list-inline">
                                    ...
                                    <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-warning"
                                            href="{{ url('cart') }}">Add to cart</a></li>
                                ...
                                <div class="row align-items-stretch">
                                    <div class="col-lg-6 p-lg-0"><a
                                            ...
                                            <a class="glightbox d-none"
                                                href="{{ URL::asset('img/products/' . $product->sku . '-files/' . $product->images[2]->image_name) }}"
                                                data-gallery="gallery1" data-glightbox=""></a></div>
                                    <div class="col-lg-6">
