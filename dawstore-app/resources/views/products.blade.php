                ...
                @endif
                    ...
                    <div class="row">
                        ...
                        @foreach ($products as $product)
                            <div class="col-lg-4 col-sm-6" data-aos="flip-down" data-aos-duration="1500">
                                <div class="product text-center">
                                            ...
                                            <ul class="mb-0 list-inline">
                                                ...
                                                @else
                                                    <li class="list-inline-item m-0 p-0"><a
                                                            ...
                                                            href="{{ route('login') }}"><i class="far fa-heart"></i></a>
                                                    </li>
                                    ...
                                    <h6> <a class="reset-anchor"
                                            href="{{ route('detail', $product) }}">{{ $product->name }}</a></h6>
